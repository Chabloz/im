...
**3**)  Indique si un nombre entier est un [nombre premier](https://fr.wikipedia.org/wiki/Nombre_premier) ou non. Testez votre fonction avec (au moins) les valeurs suivantes: 0, 1, 2, 3, 4, 11, 26, 87178291197, 87178291199.
